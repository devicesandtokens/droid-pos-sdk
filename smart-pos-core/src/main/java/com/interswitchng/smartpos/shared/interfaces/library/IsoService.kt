...
internal interface IsoService {
     ...
     */
    fun downloadKey(terminalId: String, ip: String, port: Int, isNibbsTest: Boolean,isEPMS : Boolean): Boolean {
        return false
    }
     ...
     * @param paymentModel the information required to make the current purchase
     * @return  response status indicating transaction success or failure
     */
    fun initiatePaycodePurchase(terminalInfo: TerminalInfo, code: String, paymentInfo: PaymentModel): TransactionResponse?
